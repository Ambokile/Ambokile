...
<div class="row" style="padding-left: 7%; padding-right: 5%;">
    ...
    <div class="col-sm-3">
        @if(isset($path))
            @if(strcmp("action_invoice_list",$path) == 0)
                <button class="btn btn-primary" onclick="LoadContent('{{$path}}/{{$num}}')">Back</button>
            @else
                <button class="btn btn-primary" onclick="LoadContent('{{$path}}')">Back</button>
            @endif
            @else
            <button class="btn btn-primary" onclick="LoadContent('invoice_dashboard')">Back</button>
        @endif
    </div>
</div>
...
<div class="row" style="margin-top: 5%;width: 80%;text-align: center">
    <div class="col-sm-12" style="text-align: center;color: #3C4858">
        <h4 style="font-weight: bold">Record a Payment for this Invoice</h4>
        <small>Remaining:
        <?php
...
<div class="row" style="margin-top: 5%;width: 80%">
    ...
    <div class="col-sm-8 offset-md-3" style="margin-top: 5%;">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="amount" placeholder="Enter amount" autocomplete="off" style="font-size: 14px">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <textarea class="form-control" id="notes" placeholder="Enter notes"style="font-size: 14px"></textarea>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-1 col-sm-10">
                <button type="button" id="addPayment" class="btn btn-info" onclick="addPayment('addPayment',0,{{$user_id}})">Submit</button>
            </div>
        </div>
    </div>
</div>