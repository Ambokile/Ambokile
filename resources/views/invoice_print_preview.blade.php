...
<a role="button" class="btn btn-sm btn-outline-secondary" style="float: right;" href="invoiceDownload/{{$invoice_num}}">Download PDF</a>
<div id="preview"
    ...
    <div style="margin-top: 3%;padding: 0px;width: 100%">
        <div style="padding: 0px;width: 100%;">
            <table class="table borderless" style="font-size: 11px;width: 100%;display: table">
